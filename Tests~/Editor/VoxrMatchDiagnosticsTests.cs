...
{
    public class VoxrMatchDiagnosticsTests
    {
        // 2.1
        [Test]
        public void Constructor_NullWords_DefaultsToEmpty()
        {
            var diag = new VoxrMatchDiagnostics("hello", null,
                new VoxrMatchAttempt[0], 1);
        ...
        {
            var diag = new VoxrMatchDiagnostics("hello",
                new VoxrWord[0], null, 1);
        ...
        {
            var attempt = new VoxrMatchAttempt(
        ...
        {
            var diag = new VoxrMatchDiagnostics("text",
                new[] { new VoxrWord("w", 0.9f, 0f, 0.3f) },
                new[] { new VoxrMatchAttempt("intent", "pattern", 1f, 0.6f, 0.9f, 0.4f, null, null, true) },
                42);
        ...
        {
            var diag = new VoxrMatchDiagnostics("text", null, null, 42);
            Assert.AreEqual(42, diag.Frame);
        }
        ...
        {
            var slot = new VoxrDiagnosticSlotMatch("weapon", "missiles", 1, 2, -1f);
        ...
        {
            var slot = new VoxrDiagnosticSlotMatch("target", "hotel one", 2, 4, 0.9f);
