...
// Owns:     VoxrNumberParser (public static class)
// Depends:  VoxrCommandParser (SplitSeparator)
// ============================================================================
using System;
...
{
    public static class VoxrNumberParser
    {
        ...
        public static int ParseDigitSequence(string words)
        {
            ...
            string[] tokens = words.Split(VoxrCommandParser.SplitSeparator, StringSplitOptions.RemoveEmptyEntries);
            int result = 0;
