...
// Layer:    Editor
// Owns:     VoxrBatchTestWindow (public EditorWindow)
// Depends:  VoxrBatchTestRunner, VoxrTestSuiteAsset, VoxrSlotAsset, VoxrCommandSetAsset, VoxrTestResult
// ============================================================================
using System;
using System.IO;
using UnityEditor;
...
{
    public class VoxrBatchTestWindow : EditorWindow
    {
        [SerializeField] VoxrTestSuiteAsset testSuite;
        ...
        static void Open()
        {
            GetWindow<VoxrBatchTestWindow>("VOSK Batch Tests");
        }
        ...
        void DrawExpandedDetail(VoxrTestResult r)
        {
        ...
        VoxrBatchTestRunner CreateRunner()
        {
            ...
            {
                Debug.LogError($"[VoxrBatchTest] Failed to build slots: {e.Message}");
                return null;
            }
            ...
            {
                Debug.LogError($"[VoxrBatchTest] Failed to create runner: {e.Message}");
                return null;
            }
        }

        VoxrSlotDefinition[] BuildSlots()
        {
            var list = new VoxrSlotDefinition[slotAssets.Length];
        ...
        VoxrCommandSet[] BuildSets()
        {
            var list = new VoxrCommandSet[commandSetAssets.Length];
        ...
        void ExportCsv()
        {
            ...
            File.WriteAllText(path, VoxrBatchTestRunner.ToCsv(_results));
            Debug.Log($"[VoxrBatchTest] Exported CSV to {path}");
        }
        ...
        void ImportJson()
        {
            ...
            _results = null;
            Debug.Log($"[VoxrBatchTest] Imported {testSuite.cases.Count} test cases from {path}");
        }
        ...
        void ExportJson()
        {
            ...
            Debug.Log($"[VoxrBatchTest] Exported {testSuite.cases.Count} test cases to {path}");
        }

        // ─── Helpers ────────────────────────────────────────────────────

        static string FormatActual(VoxrTestResult r)
        {
