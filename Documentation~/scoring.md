...
| `attempts[].tiedRivalIsSibling` | Whether that rival was one dropped word apart — speech ambiguity — rather than a duplicate or overlapping pattern | §3 |
